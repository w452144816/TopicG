...
import services
import storage
from ui.common import customer_dropdown_update, safe
...
def build(shared: dict) -> tuple[list, callable]:
    ...
    add_btn.click(add, [name_in, tags_in], [table, customer_dd, name_in, tags_in])
    ...
    del_btn.click(delete, [customer_dd, confirm], [table, customer_dd, confirm])
    ...
    save_tags_btn.click(save_tags, [customer_dd, edit_tags], [table, customer_dd])
    ...
    return [table, edit_tags], refresh
